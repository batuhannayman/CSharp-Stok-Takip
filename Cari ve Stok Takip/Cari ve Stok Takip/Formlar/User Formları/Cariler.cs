...
namespace Cari_ve_Stok_Takip.Formlar.User_Formları
{
    public partial class Cariler : Form
    {
        ...
        {
            dataGridView1.DataSource = BLLCari.GetRows();
        }
        ...
        {
            dataGridView1.DataSource = BLLCari.BLLSearchWithName(textBox1.Text);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = BLLCari.BLLSearchWithTC(textBox2.Text);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = BLLCari.BLLSearchWithPhone(textBox3.Text);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = BLLCari.BLLSearchWithMail(textBox4.Text);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            CariDetail.cariID = id;

            CariDetail cd = new CariDetail();
            cd.Show();
        }
    }
}
