...
namespace Cari_ve_Stok_Takip.Formlar.User_Formları
{
    public partial class SalesAdd : Form
    {
        ...
        string description = "Satış yapmak istediğiniz ürünü seçip gerekli alanları doldurmanız gerekmektedir.";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string add = BLLCari.BLLSalesAdd(cari, productID, piece, price, date, description);
